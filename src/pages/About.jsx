  ...
  return (
    <div className="about min-h-screen bg-[#164e63]">
      ...
      >
        ...
        {isMenuOpen && (
          <div
            className="z-50 absolute top-0 left-0 flex flex-col items-center justify-center gap-8 h-screen w-full py-20 backdrop-blur-xl bg-[#164e63]/90 border-t border-white/20"
          >
            <div className="flex flex-col items-center justify-between gap-4">
              <Link to="/" onClick={() => setIsMenuOpen(false)} className="text-xl font-medium">Home</Link>
              <Link to="/menu" onClick={() => setIsMenuOpen(false)} className="text-xl font-medium">Menu</Link>
              <Link to="/about" onClick={() => setIsMenuOpen(false)} className="text-xl font-medium">About</Link>
              <Link to="/gallery" onClick={() => setIsMenuOpen(false)} className="text-xl font-medium">Gallery</Link>
              <Link to="/contact" onClick={() => setIsMenuOpen(false)} className="text-xl font-medium">Contact</Link>
            </div>
          </div>
        )}
      </motion.header>
